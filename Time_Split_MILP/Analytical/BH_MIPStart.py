...
def BH(total_range,total_constraints,val,row,col, b, obj, vtype, MIPGap, mip_start):
...
#result,data,solutions=BH(mat['total_range'],mat['total_constraints'],mat['val'],mat['row'],mat['col'], mat['b'], mat['obj'], mat['vtype'], mat['MIPGap'],mat['mip_start'])
result,data,solutions=BH(total_range,total_constraints,val,row,col, b, obj, vtype, MIPGap,mip_start)
