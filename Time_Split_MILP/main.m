...
[c_scenario,B_T,P_T,Adj_c,Adj_u,UpC,n_users,number_cells, rings,beams,theta,colours,frame,frame_dur,freq,M,N,P,D,R,A,total_range,total_constraints,b, vtype,mip_start,i_index,m_index,b_index,x_index,z_index,g_index,f_index,c_index,a_p_index,a_n_index,i_range,m_range,b_range,x_range,z_range,g_range,f_range,c_range,a_p_range,a_n_range,i_aux,m_aux,b_aux,x_aux,z_aux,g_aux,f_aux,c_aux,a_p_aux,a_n_aux,t_contraint_label]=BH(n_users,P_T,frame,scenario);
