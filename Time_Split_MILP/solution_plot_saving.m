...
function [max_UC_betta_0,max_EC_betta_1,max_TTS_betta_1]=solution_plot_saving(scenario,run,betta,normalization_UC,normalization_EC,normalization_time,data,solutions,c_scenario,B_T,P_T,Adj_c,Adj_u,UpC,n_users,number_cells,rings,beams,theta,colours,frame,frame_dur,freq, M,N,P,D,i_range, b_index, b_range, m_index, m_range, g_index, g_range, f_index, f_range, c_index, c_range, z_index, z_range, x_index, x_range,t_current)
    ...
    for i=1:size(solutions,1)
        [UC_perc,EC_perc,TTS,UC_perc_db,EC_perc_db,TTS_db, o1, o2, o3, Ill_out, B_out, P_out, MS, GS, FS, CS, ZS, XS, PS, DS]=FOM_Estimation(c_scenario,B_T,P_T,Adj_c,Adj_u,UpC,n_users,number_cells,rings,beams,theta,colours,frame,frame_dur,freq, M,N,P,D,solutions(i,:),i_range, b_index, b_range, m_index, m_range, g_index, g_range, f_index, f_range, c_index, c_range, z_index, z_range, x_index, x_range, t_current);
        O1(i)=o1;
        O2(i)=o2;
        O3(i)=o3;
    ...
    Filename=strcat('[',num2str(scenario+1),'s_',num2str(run),'r_splitted]_',num2str(betta),'betta_',num2str(t_current+9),'frame_',num2str(n_users),'u','.mat');
    b_slots=N;
