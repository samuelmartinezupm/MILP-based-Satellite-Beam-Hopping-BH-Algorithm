function [RC,SC,UC,EC,TTS, Ill,B,P]=FOM_calculation_demand_based_band_slots_fixed_MODCODs(B_T,b_slots, P_T, Ill, B, P,c_scenario,n_users, beams, theta, colours, frame, frame_dur, TTL, freq,P_list)
RC=0;
SC=0;
UC=0;
EC=0;
