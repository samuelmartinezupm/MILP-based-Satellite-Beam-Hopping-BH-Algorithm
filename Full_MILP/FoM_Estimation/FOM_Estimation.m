function [UC_perc,EC_perc,TTS,UC_perc_db,EC_perc_db,TTS_db, o1, o2, o3, Ill_out, B_out, P_out, MS, GS, FS, CS, ZS, XS, PS, DS]=FOM_Estimation(c_scenario,B_T,P_T,Adj_c,Adj_u,UpC,n_users,number_cells,rings,beams,theta,colours,frame,frame_dur,freq, M,N,P,D,solutions,i_range, b_index, b_range, m_index, m_range, g_index, g_range, f_index, f_range, c_index, c_range, z_index, z_range, x_index, x_range)
...
%% 2) DEMAND BASED:
    ...
    %Band Segregation:
    [RC_db,SC_db,UC_db,EC_db,TTS_db, Ill_db,B_db,P_db]=FOM_calculation_demand_based_band_slots(B_T,b_slots, P_T, Ill, B, P,c_scenario,n_users, beams, theta, colours, frame, frame_dur, TTL, freq);
...
%% 3) OPTIMIZATION-BASED:
    ...
    [RC,SC,UC,EC,TTS]=FOM_calculation_optimization_based(B_T,b_slots, P_T,  Ill_out, B_out, P_out, UpC, c_scenario, n_users, theta, frame, frame_dur, freq);
